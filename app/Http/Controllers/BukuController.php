...
class BukuController extends Controller
{
    ...
    public function update(UpdateBukuRequest $request, $id)
    {
        ...
        Alert::success('Data Buku Berhasil di Update!', 'Anda akan dialihkan ke halaman utama.');
        return redirect('/buku');
    }
    ...
    public function destroy($id)
    {
        ...
        Buku::destroy($id);
        Alert::success('Data Buku Berhasil di Hapus!', 'Anda akan dialihkan ke halaman utama.');
        return redirect('/buku');
    }
}
